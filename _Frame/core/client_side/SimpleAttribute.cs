...
namespace SPA
{
    ...
    {
        public FindChildComponentAttribute(string name=null) : base(name) {}
        public override void Set(MonoBehaviour mono, FieldInfo field)
        {
          
            var ts = mono.gameObject.transform.Find(name ?? field.Name);
    ...
    {
        public int index = 0;
        public GetChildAttribute(int index) : base(index.ToString()) {
            this.index = index;
        }
        public override void Set(MonoBehaviour mono, FieldInfo field)
        {
